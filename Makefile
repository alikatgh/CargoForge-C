...
SRCS = $(SRC_DIR)/main.c $(SRC_DIR)/cli.c $(SRC_DIR)/parser.c $(SRC_DIR)/analysis.c $(SRC_DIR)/placement_2d.c $(SRC_DIR)/placement_3d.c $(SRC_DIR)/constraints.c $(SRC_DIR)/visualization.c $(SRC_DIR)/json_output.c
